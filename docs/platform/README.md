...
<!-- docs-nav-start -->
[Previous: Native Tour Of The Demo](/miscellaneous/02-native-tour-of-the-demo) | [Documentation Home](/) | [Next: Project](/project/)
<!-- docs-nav-end -->
...
The main technical reference now lives in [Coredeux Core Reference](/modules/coredeux-core/13-reference).
...
- [Coredeux Core Module System](/modules/coredeux-core/05-modules)
- [Coredeux Core Module Guide](/modules/coredeux-core/)
