...
<!-- docs-nav-start -->
[Documentation Home](README.md) | [Next: What Is Coredeux?](01-what-is-coredeux.md)
<!-- docs-nav-end -->
...
This homepage follows the same reading order as the site. Start at the top and
keep going down when you want the full story in sequence.
